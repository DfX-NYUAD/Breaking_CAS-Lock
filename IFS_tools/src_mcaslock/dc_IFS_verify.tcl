...
read_verilog -netlist ../Results_mcaslock/$design/${design}_lock_${tool}_synth_${lib}.v
...
write -format verilog -hierarchy -output ../Results_mcaslock/$design/${design}_lock_${tool}_synth_${lib}_verify.v
