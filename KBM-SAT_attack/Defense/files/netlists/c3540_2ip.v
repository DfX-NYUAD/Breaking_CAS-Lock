...
module c3540 ( G1, G13, G20, G33, G41, G45, G50, G58, G68, G77, G87, G97, G107, 
  ...
  wire   n875, n876, n877, n878, n879, n880, n881, n882, n883, n884, n885,
  ...
  NOR2_X1 U1299 ( .A1(G264), .A2(G257), .ZN(n1204) );
  NOR2_X1 U1300 ( .A1(n1657), .A2(n1204), .ZN(n1205) );
  NAND2_X1 U1301 ( .A1(n1205), .A2(G250), .ZN(n1223) );
  NAND2_X1 U1302 ( .A1(G68), .A2(G238), .ZN(n1207) );
  NAND2_X1 U1303 ( .A1(G77), .A2(G244), .ZN(n1206) );
  NAND2_X1 U1304 ( .A1(n1207), .A2(n1206), .ZN(n1211) );
  NAND2_X1 U1305 ( .A1(G50), .A2(G226), .ZN(n1209) );
  NAND2_X1 U1306 ( .A1(G58), .A2(G232), .ZN(n1208) );
  NAND2_X1 U1307 ( .A1(n1209), .A2(n1208), .ZN(n1210) );
  NOR2_X1 U1308 ( .A1(n1211), .A2(n1210), .ZN(n1219) );
  NAND2_X1 U1309 ( .A1(G87), .A2(G250), .ZN(n1213) );
  NAND2_X1 U1310 ( .A1(G97), .A2(G257), .ZN(n1212) );
  NAND2_X1 U1311 ( .A1(n1213), .A2(n1212), .ZN(n1217) );
  NAND2_X1 U1312 ( .A1(G270), .A2(G116), .ZN(n1215) );
  NAND2_X1 U1313 ( .A1(G107), .A2(G264), .ZN(n1214) );
  NAND2_X1 U1314 ( .A1(n1215), .A2(n1214), .ZN(n1216) );
  NOR2_X1 U1315 ( .A1(n1217), .A2(n1216), .ZN(n1218) );
  NAND2_X1 U1316 ( .A1(n1219), .A2(n1218), .ZN(n1221) );
  NAND2_X1 U1317 ( .A1(n1221), .A2(n1220), .ZN(n1222) );
  NAND2_X1 U1318 ( .A1(n1223), .A2(n1222), .ZN(n1226) );
  NAND2_X1 U1319 ( .A1(G50), .A2(n1738), .ZN(n1664) );
  NAND2_X1 U1320 ( .A1(G20), .A2(n1224), .ZN(n1284) );
  NOR2_X1 U1321 ( .A1(n1664), .A2(n1284), .ZN(n1225) );
  NOR2_X1 U1322 ( .A1(n1226), .A2(n1225), .ZN(G361) );
  ...
  XOR2_X1 U1329 ( .A(n1459), .B(n1552), .Z(G358) );
  ...
  XNOR2_X1 U1335 ( .A(n1661), .B(n1634), .ZN(G351) );
  NOR2_X1 U1336 ( .A1(n1235), .A2(n1268), .ZN(G372) );
  ...
  NAND2_X1 U1349 ( .A1(n1527), .A2(n1525), .ZN(G399) );
  INV_X1 U1350 ( .A(n1643), .ZN(n1519) );
  NOR2_X1 U1351 ( .A1(G116), .A2(n1246), .ZN(n1467) );
  NAND2_X1 U1352 ( .A1(n1467), .A2(G1), .ZN(n1247) );
  NAND2_X1 U1353 ( .A1(n1519), .A2(n1247), .ZN(n1249) );
  NAND2_X1 U1354 ( .A1(n1643), .A2(n1664), .ZN(n1248) );
  NAND2_X1 U1355 ( .A1(n1249), .A2(n1248), .ZN(n1253) );
  NOR2_X1 U1356 ( .A1(n1251), .A2(n1250), .ZN(n1640) );
  OR2_X1 U1357 ( .A1(G1), .A2(n1640), .ZN(n1252) );
  NAND2_X1 U1358 ( .A1(n1253), .A2(n1252), .ZN(G364) );
  INV_X1 U1359 ( .A(n1254), .ZN(n1256) );
  INV_X1 U1360 ( .A(G116), .ZN(n1656) );
  NOR2_X1 U1361 ( .A1(n1656), .A2(n1284), .ZN(n1255) );
  NAND2_X1 U1362 ( .A1(n1256), .A2(n1255), .ZN(n1295) );
  NAND2_X1 U1363 ( .A1(n1257), .A2(G1), .ZN(n1286) );
  ...
  NOR2_X1 U1373 ( .A1(n1269), .A2(n1268), .ZN(n1270) );
  XNOR2_X1 U1374 ( .A(n1342), .B(n1270), .ZN(n1271) );
  NAND2_X1 U1375 ( .A1(n1271), .A2(G330), .ZN(n1280) );
  ...
  XNOR2_X1 U1382 ( .A(n1280), .B(n1345), .ZN(n1281) );
  XNOR2_X1 U1383 ( .A(n1282), .B(n1281), .ZN(n1283) );
  NAND2_X1 U1384 ( .A1(n1284), .A2(n1283), .ZN(n1285) );
  NAND2_X1 U1385 ( .A1(n1286), .A2(n1285), .ZN(n1293) );
  INV_X1 U1386 ( .A(n1286), .ZN(n1291) );
  NAND2_X1 U1387 ( .A1(G58), .A2(G50), .ZN(n1287) );
  XNOR2_X1 U1388 ( .A(n1287), .B(G68), .ZN(n1289) );
  NAND2_X1 U1389 ( .A1(n1736), .A2(G50), .ZN(n1288) );
  NAND2_X1 U1390 ( .A1(n1289), .A2(n1288), .ZN(n1290) );
  NAND2_X1 U1391 ( .A1(n1291), .A2(n1290), .ZN(n1292) );
  NAND2_X1 U1392 ( .A1(n1293), .A2(n1292), .ZN(n1294) );
  NAND2_X1 U1393 ( .A1(n1295), .A2(n1294), .ZN(G367) );
  ...
  XNOR2_X1 U1776 ( .A(n1734), .B(n1733), .ZN(G402) );
  NAND2_X1 U1777 ( .A1(n1736), .A2(n1735), .ZN(n1737) );
  NOR2_X1 U1778 ( .A1(n1738), .A2(n1737), .ZN(G353) );
  NAND2_X1 U1779 ( .A1(n1740), .A2(n1739), .ZN(n1741) );
  NAND2_X1 U1780 ( .A1(n1742), .A2(n1741), .ZN(G369) );
  NOR2_X1 U1781 ( .A1(G390), .A2(G393), .ZN(n1747) );
  NOR2_X1 U1782 ( .A1(G375), .A2(G378), .ZN(n1748) );
  OR2_X1 U1783 ( .A1(G396), .A2(G384), .ZN(n1743) );
  NOR2_X1 U1784 ( .A1(G387), .A2(n1743), .ZN(n1744) );
  NAND2_X1 U1785 ( .A1(n1748), .A2(n1744), .ZN(n1745) );
  NOR2_X1 U1786 ( .A1(G381), .A2(n1745), .ZN(n1746) );
  NAND2_X1 U1787 ( .A1(n1747), .A2(n1746), .ZN(G407) );
  NAND2_X1 U1788 ( .A1(n1749), .A2(n1748), .ZN(n1750) );
  AND2_X1 U1789 ( .A1(n1750), .A2(G407), .ZN(n1751) );
  NAND2_X1 U1790 ( .A1(G213), .A2(n1751), .ZN(G409) );
endmodule
