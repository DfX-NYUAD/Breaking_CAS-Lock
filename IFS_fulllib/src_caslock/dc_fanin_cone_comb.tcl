...
echo "number of gates in $PO = $max" > ../Results_caslock/$design/num_of_gates.txt
...
write -format verilog -hierarchy -output ../Results_caslock/$design/${design}_${PO}.v
exit
