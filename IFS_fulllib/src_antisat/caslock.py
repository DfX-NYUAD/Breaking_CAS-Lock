...
def caslock(name, PO, keysize):
    ...
    with open("../Results_caslock/"+name+"/"+name+"_"+PO+".bench") as fi:
        content = fi.readlines()
...
def antisat(name, PO, keysize):
    ...
    with open("../Results_antisat/"+name+"/"+name+"_"+PO+".bench") as fi:
        content = fi.readlines()
