...
#sh mkdir -p ../../Results_antisat/$design/database
#sh mkdir -p ../../Results_antisat/$design/reports
#sh mkdir -p reports
...
read_verilog -netlist ../Results_antisat/$design/${design}_lock_synth_${lib}.v
...
write -format verilog -hierarchy -output ../Results_antisat/$design/${design}_lock_synth_${lib}_caslock.v
