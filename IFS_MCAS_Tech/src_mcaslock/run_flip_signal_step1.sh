...
setenv LIB 2ip 
dc_shell-t -x "source -echo -verbose ./post_abc_synth_2ip_32nm.tcl" |tee ${DESIGN}_post_abc_synth_${LIB}_32nm_log
dc_shell-t -x "source -echo -verbose ./post_abc_synth_2ip_45nm.tcl" |tee ${DESIGN}_post_abc_synth_${LIB}_45nm_log
dc_shell-t -x "source -echo -verbose ./post_abc_synth_2ip_65nm.tcl" |tee ${DESIGN}_post_abc_synth_${LIB}_65nm_log
