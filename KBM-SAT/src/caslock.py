...
def mcaslock(name, PO, keysize):
    ...
    for i in range(2, int(keysize)):
        ...
        if i%2 == 1: 
            CASBlock1 = CASBlock1 + "AND_"+str(i)+" = AND(input_"+str(i)+", OR_"+str(i-1)+")\n"
        else:
            CASBlock1 = CASBlock1 + "OR_"+str(i)+" = OR(input_"+str(i)+", AND_"+str(i-1)+")\n"
    ...
    for i in range(2, int(keysize)):
        ...
        if i%2 == 1: 
            CASBlock2 = CASBlock2 + "AND_"+str(i+int(keysize))+" = AND(input_"+str(i+int(keysize))+", OR_"+str(i+int(keysize)-1)+")\n"
        else:
            CASBlock2 = CASBlock2 + "OR_"+str(i+int(keysize))+" = OR(input_"+str(i+int(keysize))+", AND_"+str(i+int(keysize)-1)+")\n"
...
if __name__ == "__main__":
    ...
    main(args.name, bool(int(args.mcas) == 1),  args.PO, args.keysize)
