...
echo "number of gates in $PO = $max" > ../Results_antisat/$design/num_of_gates.txt
...
write -format verilog -hierarchy -output ../Results_antisat/$design/${design}_${PO}.v
exit
