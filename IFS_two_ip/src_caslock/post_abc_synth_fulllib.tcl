...
analyze -library WORK -format sverilog ../Results_caslock/$design/${design}_lock.v
...
write -format verilog -hierarchy -output ../Results_caslock/$design/${design}_lock_synth_fulllib.v 
exit
