...
set target_library {/home/nsl278/db/NangateOpenCellLibrary_slow.db}
set link_library {/home/nsl278/db/NangateOpenCellLibrary_slow.db}
...
#set_attribute [get_lib_cells sc9_cmos10lpe_base_hvt_ss_nominal_max_1p08v_125c/TIE*] dont_use false


analyze -library WORK -format sverilog ../../Defense/Results/$design/${design}_lock.v
...
#To prevent dc creating assign statements
#set verilogout_no_tri true
#set verilogout_equation false
#set hdlin_while_loop_iterations 40960
